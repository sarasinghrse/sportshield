        ...
        <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(26,92,26,0.15)', border: '1px solid rgba(26,92,26,0.3)', borderRadius: 20, padding: '5px 14px', marginBottom: 20 }}>
              <span style={{ color: '#4ade80', fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Individual Athlete</span>
            </div>
            <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(1.8rem, 4vw, 2.6rem)', color: '#fff', lineHeight: 1.1, marginBottom: 16 }}>
              Individual Athlete Demo
            </h1>
            <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1rem', maxWidth: 560, margin: '0 auto', lineHeight: 1.7 }}>
              See how individual athletes and content creators use SportShield to protect their personal sports media and take action against unauthorized use.
            </p>
          </div>
          ...
          <div className="ap-card" style={{ padding: '48px 32px', textAlign: 'center', marginBottom: 32 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.92rem', maxWidth: 480, margin: '0 auto 28px', lineHeight: 1.7 }}>
              This page will showcase a complete use case diagram with all functionalities available to individual athletes — including personal asset protection, WhatsApp scanning, ownership certificates, DMCA generation, and compensation recovery.
            </p>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, maxWidth: 600, margin: '0 auto 32px' }}>
              {[
                { title: 'Upload & Protect', desc: 'Fingerprint your sports photos' },
                { title: 'WhatsApp Scan', desc: 'Scan from your phone instantly' },
                { title: 'Ownership Proof', desc: 'Generate proof certificates' },
                { title: 'DMCA Notices', desc: 'One-click takedown generation' },
                { title: 'Alert Monitoring', desc: 'Real-time piracy notifications' },
                { title: 'Compensation', desc: 'Recover fees from violators' },
              ].map(f => (
