...
from routers import media, alerts, contact, whatsapp, settings, gemini, admin, url_monitor, reports
...
app.include_router(url_monitor.router, prefix="/api/url-monitor")
